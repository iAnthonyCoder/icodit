---
title: How to customize the default Laravel Auth template
date: "2017-08-21"
...
---
 ...
 I ssswanted to write a simple application in plain JavaScript using the [model-view-controller](https://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93controller) architectural pattern. So I did, and here it is. Hopefully it helps you understand MVC, as it's a difficult concept to wrap your head around when you're first starting out.


<!-- IMAGEN PRINCIPAL, SIEMPRE LUEGO DE UN PARRAFO -->
![Laravel](lara.jpg)
![Laravel](lara.jpg)
<div class="img-desc">this is the description of this image. Credits:&nbsp;<a href="#">asdw</a></div><!--Colocar siempre creditos-->
...
<div class="topbar">index.html</div>
...
<div class="topbar">Controller</div>
